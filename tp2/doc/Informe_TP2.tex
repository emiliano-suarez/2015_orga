...
En el .set se agrego jalreg como como instrucción y jalr como pseudoinstruccion utilizando la anterior y seteandola de manera tal que cumpla con la especificacion de jr. En la sección de control se activa el cable de Jump, RegDst, MemToReg en el valor ``2'' y RegWrite en el valor ``1'' para permitir la escritura.
