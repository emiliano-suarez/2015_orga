...
//int sha1(unsigned char *result, char *bloques, unsigned long long length);
extern int sha1(unsigned char *resultado, char *bloques, unsigned long long length);
